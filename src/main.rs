...
/*
    TODO FOR NEXT TIME: Determine whether we actually want remainder mechanism in magnet_message, determine if there's a way to disable requiring bencoded messages to have sorted fields.
     Error { context: None, error: StructureError(UnsortedKeys) }
